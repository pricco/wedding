...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guest.table'
        db.add_column(u'rsvp_guest', 'table',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guest.table'
        db.delete_column(u'rsvp_guest', 'table')
    ...
    models = {
        u'rsvp.group': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'WKW'", 'unique': 'True', 'max_length': '3'}),
